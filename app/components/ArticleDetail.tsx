...
export function ArticleDetail({ category, title, intro, outline, sections, source, labels, research, publication }: {
  ...
  const text = labels ?? { back: 'Усі погляди', structure: 'Структура', source: 'Опублікований препринт', discussion: 'Дискусія', discussionTitle: 'Гіпотеза стає сильнішою, коли її намагаються спростувати.', feedback: 'Залишити аргумент або запитання', backHref: '/ua/visions' };
  return (
